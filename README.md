...
## Артефакты киберимунного подхода
...
* аутентификация пользователя с невалидной логин-парольной парой;
...
При этом, как продемонстрировано, цель безопасности достигнута: неаутентифицированным `Пользователям` данные из `Базы Данных` не предоставлются. 
